...
Фактический прогон выполнен 8 мая 2026 года командой `mvn clean test -Dbrowser=all -Dheadless=true`. Автоматизированные сценарии успешно отработали в Google Chrome и Mozilla Firefox.

| Тестовый сценарий | Chrome | Firefox | Результат |
| --- | --- | --- | --- |
| Открытие главной страницы | passed | passed | успешно |
| Поиск треков | passed | passed | успешно |
| Открытие трека | passed | passed | успешно |
| Воспроизведение трека | passed | passed | успешно |
| Пауза трека | passed | passed | успешно |
| Переход на страницу автора | passed | passed | успешно |
| Открытие Share | passed | passed | успешно |
| Переход к Upload | passed | passed | успешно |
| Открытие формы входа | passed | passed | успешно |
| Вход с некорректными данными | passed | passed | успешно |

Сводка прогона: `29` тестов, `0` failures, `0` errors, `1` skipped.

Пропущенный сценарий: `PlayerTest#shouldFinishPlaybackAndClose`. Тест помечен `@Disabled` как ручной длительный сценарий ожидания завершения внешнего воспроизведения на SoundCloud и не участвует в основном автоматизированном прогоне.
